...
We aim to keep `Smart-Rent-System` up to date and secure. Please see below for the versions we currently support with security updates.
...
We value the contributions from the community and encourage responsible disclosure to help keep `Smart-Rent-System` safe and secure for all users.
